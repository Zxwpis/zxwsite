...
const changelogData: ChangelogEntry[] = [
  {
    ...
    type: 'major',
    changes: [
      { type: 'feature', description: 'Redesigned, more user-friendly interface' },
      { type: 'feature', description: 'Added new tweaks and refreshed existing ones' },
      { type: 'feature', description: 'Extra Nvidia GPU-specific optimizations' },
      { type: 'feature', description: 'New Ping Monitor page' },
      { type: 'improvement', description: 'Expanded optimization pack for Ultimate-tier users' },
      { type: 'improvement', description: 'Updated BIOS optimization guidance' },
      { type: 'improvement', description: 'Additional options in Settings' },
    ],
  },
  {
    version: '2.0.0',
    ...
    type: 'major',
    changes: [
      { type: 'feature', description: 'Introduced the graphical interface (moved on from the first CLI-style build)' },
      { type: 'feature', description: 'Added the licensing system' },
      { type: 'feature', description: 'First prototype of the PC optimization pack' },
      { type: 'feature', description: 'Prototype of BIOS configuration guidance' },
      { type: 'improvement', description: 'Removed outdated/unused tweaks left over from the first build' },
      { type: 'improvement', description: 'Minor improvements to existing tweaks' },
    ],
  },
  {
    version: '1.5.2',
    ...
    type: 'patch',
    changes: [
      { type: 'feature', description: 'First official build of ZXWY' },
      { type: 'feature', description: 'Initial set of tweaks' },
      { type: 'improvement', description: 'Early version — included clutter and some irrelevant optimizations later removed in 2.0.0' },
    ],
  },
];
