  ...
  return (
    <section className="py-12 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-yellow-500/10 via-orange-500/5 to-transparent border border-yellow-500/20 p-6 md:p-8">
          {/* Background Pattern */}
          ...
          <div className="relative flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
            ...
            <div className="flex-shrink-0">
              <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-green-500/10 border border-green-500/20">
                ...
                <span className="text-sm font-medium text-green-500">Auto Backup Enabled</span>
              </div>
            </div>
          </div>

          {/* Bottom Note */}
          <div className="relative mt-6 pt-4 border-t border-yellow-500/10 flex items-center gap-2 text-xs text-muted-foreground">
